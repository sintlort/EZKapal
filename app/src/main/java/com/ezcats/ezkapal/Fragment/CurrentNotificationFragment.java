...
public class CurrentNotificationFragment extends Fragment implements NotificationAdapter.OnNotificationListener, NotificationAdapter.OnOpenNotification {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_current_notification, container, false);
        init(v);
        initData();
        return v;
    }
    ...
    private void initData() {
        ...
        Call<NotificationJSONModel> call = accountService.getCurrentNotification("application/json","XMLHttpRequest",token);
    ...
    private void init(View v) {
        ...
        recyclerView = v.findViewById(R.id.current_notification_recycler);
        constraintLayout = v.findViewById(R.id.constraint_current_notification_not_found);
    }
